...
export const routes: Routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        title: 'Defer Views',
        loadComponent: () =>
          import('./dashboard/pages/defer-wiews/defer-wiews.component'),
      },
      {
        path: 'user/:id',
        title: 'User View',
      ...
      {
        path: 'view-transition-two',
        title: 'View Transition Two',
        loadComponent: () =>
          import(
            './dashboard/pages/view-transition-two/view-transition-two.component'
          ),
      },
      {
        path: '',
